 ...
 */
public class Activity_LoginTienda extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(Activity_LoginTienda.this, android.R.layout.simple_dropdown_item_1line, emailAddressCollection);
    ...
    public void interfazRegistro(View view){
        Intent cambio = new Intent(this, Activity_Registro.class);
