...
class Insert:
    ...
    def POST(self):
        ...
        # call model insert_tipos_productos and try to insert new data
        config.model.insert_tipos_productos(
            form['nombre_producto'],form['imagen_producto'],form['id_categoria'],
        )
